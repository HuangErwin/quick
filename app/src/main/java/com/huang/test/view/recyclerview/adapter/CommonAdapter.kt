package com.huang.test.view.recyclerview.adapter
...
import com.huang.test.view.recyclerview.MultipleType
import com.huang.test.view.recyclerview.ViewHolder
import com.huang.test.view.recyclerview.adapter.OnItemClickListener
import com.huang.test.view.recyclerview.adapter.OnItemLongClickListener
...
abstract class CommonAdapter<T>(var mContext: Context, var mData: ArrayList<T>, //条目布局
     ...
     * 加载布局
     */
    public fun inflaterView(mLayoutId: Int, parent: ViewGroup): View {
        //创建view
        val view = mInflater?.inflate(mLayoutId, parent, false)
